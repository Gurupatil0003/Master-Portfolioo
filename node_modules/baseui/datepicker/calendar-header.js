...
function (_React$Component) {
  ...
  function CalendarHeader() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderPreviousMonthButton", function (_ref4) {
      ...
      var minYear = _this.props.minDate ? (0, _index4.getYear)(_this.props.minDate) : MIN_YEAR;

      if ((0, _index4.getYear)(nextMonth) < minYear) {
        isDisabled = true;
      }
    ...
    _defineProperty(_assertThisInitialized(_this), "renderNextMonthButton", function (_ref5) {
      ...
      var maxYear = _this.props.maxDate ? (0, _index4.getYear)(_this.props.maxDate) : MAX_YEAR;

      if ((0, _index4.getYear)(nextMonth) > maxYear) {
        isDisabled = true;
      }
        ...
        return React.createElement(_index3.LocaleContext.Consumer, null, function (locale) {
          return React.createElement(React.Fragment, null, React.createElement(CalendarHeader, _extends({}, calendarHeaderProps, {
            ...
            return React.createElement(WeekdayHeader, _extends({
              key: offset,
              alt: (0, _index4.getWeekdayInLocale)(day, _this2.props.locale)
