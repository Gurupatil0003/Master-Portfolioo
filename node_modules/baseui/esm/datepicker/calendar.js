...
function (_React$Component) {
  ...
  function Calendar(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleMonthChange", function (date) {
      _this.setHighlightedDate(getStartOfMonth(date));
    ...
    _defineProperty(_assertThisInitialized(_this), "handleDateChange", function (data) {
      ...
      if (Array.isArray(data.date)) {
        ...
        var nextDate = applyDateToTime(_this.props.value, data.date);
        onChange({
          date: nextDate
        });
      } else {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleTimeChange", function (time, index) {
      ...
      if (Array.isArray(_this.props.value)) {
        ...
        var date = applyTimeToDate(_this.props.value, time);
        onChange({
          date: date
        });
      }
    ...
    _this.state = {
      highlightedDate: _highlightedDate && isSameMonth(dateInView, _highlightedDate) ? _highlightedDate : _this.getSingleDate(_value) || new Date(),
      focused: false,
      date: dateInView,
      quickSelectId: null,
      rootElement: null
