...
import { addDays, addMonths, getMonth, getMonthInLocale, getStartOfWeek, getWeekdayInLocale, getWeekdayMinInLocale, getYear, monthDisabledBefore, monthDisabledAfter, setMonth, setYear, subMonths } from './utils/index.js';
        ...
        return React.createElement(LocaleContext.Consumer, null, function (locale) {
          return React.createElement(React.Fragment, null, React.createElement(CalendarHeader, _extends({}, calendarHeaderProps, {
            ...
            return React.createElement(WeekdayHeader, _extends({
              key: offset,
              alt: getWeekdayInLocale(day, _this2.props.locale)
