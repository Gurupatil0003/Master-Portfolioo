...
export const Root = styled('span', props => {
  ...
  const borderRadius = $theme.borders.useRoundedCorners ? $theme.borders.radius400 : 0;
  ...
  return { ...font150,
    ...
    ':focus': $disabled || !$clickable && !$closeable ? {} : {
      boxShadow: props.$isFocusVisible ? `0 0 0 3px ${props.$kind === KIND.accent ? $theme.colors.primaryA : $theme.colors.accent}` : 'none'
    }
  };
});
